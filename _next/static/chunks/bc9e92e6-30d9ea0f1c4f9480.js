"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{JU:function(){return iD},QT:function(){return sr},ad:function(){return iV},cf:function(){return so},hJ:function(){return ib},pl:function(){return ss},r7:function(){return sa}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(e){e=iI(e,iA);let t=iI(e.firestore,iL);return(function(e,t,n={}){let r=new N;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new iu({next:s=>{t.enqueueAndForget(()=>rF(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rB(e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rO(e,a)})(await ip(e),e.asyncQueue,t,n,r)),r.promise})(iM(t),e._key).then(n=>su(t,e,n))}class si extends i6{constructor(e){super(),this.firestore=e}convertBytes(e){return new iF(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iA(this.firestore,null,t)}}function ss(e,t,n){var r;e=iI(e,iA);let i=iI(e.firestore,iL),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sl(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,n,i);iZ("Data must be an object, but it was:",l,r);let u=iX(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i0(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i4(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new i$(new eM(u),a,o)})(iW(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tb.none())])}function sa(e,t,n,...r){e=iI(e,iA);let i=iI(e.firestore,iL),s=iW(i);return sl(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iP?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i0(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i0(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i4(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof iH)u.push(t);else{let e=iY(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iK(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);iZ("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i2(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof iH)s.push(o);else{let e=iY(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iK(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tb.exists(!0))])}function so(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||ix(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(ix(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iA)a=iI(e.firestore,iL),o=e8(e._key.path),s={next:n=>{t[u]&&t[u](su(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iI(e,iN);a=iI(n.firestore,iL),o=n._query;let r=new si(a);s={next:e=>{t[u]&&t[u](new sn(a,r,n,e))},error:t[u+1],complete:t[u+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new S(C.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query)}return function(e,t,n,r){let i=new iu(r),s=new rB(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rO(await ip(e),s)),()=>{i.za(),e.asyncQueue.enqueueAndForget(async()=>rF(await ip(e),s))}}(iM(a),o,c,s)}function sl(e,t){return function(e,t){let n=new N;return e.asyncQueue.enqueueAndForget(async()=>r0(await ig(e).then(e=>e.syncEngine),t,n)),n.promise}(iM(e),t)}function su(e,t,n){let r=n.docs.get(t._key),i=new si(e);return new se(e,i,t._key,r,new i7(n.hasPendingWrites,n.fromCache),t.converter)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iL(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);